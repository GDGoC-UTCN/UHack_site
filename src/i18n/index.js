...
export const t = {
  ro: {
    ...
    contact: {
      ...
      subtitle:    'Ai întrebări despre hackathon? Scrie-ne — răspundem în maxim 48 de ore.',
      name:        'Nume complet',
      email:       'Adresă de email',
      category:    'Categorie',
      categoryPh:  'Alege o categorie…',
      categoryOpts: [
        { value: 'general',     label: 'Întrebare generală' },
        { value: 'register',    label: 'Înscriere & eligibilitate' },
        { value: 'partnership', label: 'Parteneriat / Sponsorizare' },
      ...
      successSub:  'Îți mulțumim că ne-ai contactat. Revenim cu un răspuns în maxim 48 de ore.',
      successAnother: 'Trimite alt mesaj',
      error:       '❌ Ceva n-a mers. Încearcă din nou sau scrie-ne direct la',
      namePh:      'Ion Popescu',
      emailPh:     'ion@example.com',
      messagePh:   'Descrie în detaliu întrebarea sau solicitarea ta…',
      responseTime: 'Răspuns în max. 48h',
      emailLabel:  'Email',
      instagramLabel: 'Instagram',
      linkedinLabel:  'LinkedIn',
      locationLabel:  'Locație',
      venueLabel:     'Venue',
      venueValue:     'FC Universitatea Cluj Campus',
    },
  ...
  en: {
    ...
    contact: {
      tag:         '// contact',
      title:       'Get in touch',
      subtitle:    'Have questions about the hackathon? Write to us — we reply within 48 hours.',
      name:        'Full name',
      email:       'Email address',
      category:    'Category',
      ...
      categoryOpts: [
        ...
        { value: 'register',    label: 'Registration & eligibility' },
      ...
      successSub:  'Thanks for reaching out. We\'ll get back to you within 48 hours.',
      successAnother: 'Send another message',
      error:       '❌ Something went wrong. Try again or email us directly at',
      namePh:      'John Doe',
      emailPh:     'john@example.com',
      messagePh:   'Describe your question or request in detail…',
